...
// import back from "../../../public/assets/images/back.webp";
  ...
  return (
    <div className="py-40 mx-auto max-w-[1600px] flex justify-center items-center">
      <div className="flex flex-col items-center bg-white dark:bg-c6 shadow-2xl rounded-md  relative w-[90%] md:w-[60%] lg:w-[50%] xl:w-[40%] ">
        ...
        <form className="flex flex-col justify-center items-center gap-3 w-[100%] mt-8" onSubmit={e => {
          e.preventDefault();
        }} >
          <input
            type="email"
          ...
          >
            <Link href="#">Send Recovery Email</Link>
          </button>
        </form>
        ...
        <div className=" flex flex-col lg:flex-row justify-center gap-4 lg:gap-0 items-center h-5 w-[80%] lg:justify-between mt-5">
          <span className="flex gap-2 text-xs md:text-sm text-c2">
            {" "}
            <Image src={"https://images.infinitydigitalassets.io/assets/images/back.webp"} width={20} height={20} alt="back logo" />
            <Link
              className={`text-xs cursor-pointer md:text-sm ${theme === "light" ? "text-blue" : "text-c8"}`}
              href="/login"
            >
              Back to login
            </Link>
          ...
          <span className="flex gap-1 text-xs md:text-sm text-c1 dark:text-c2">
            ...
            <Link
              href="/register"
              className={`cursor-pointer text-normal ${theme === "light" ? "text-blue" : "text-c8"}`}
            >
              Signup
            </Link>
          </span>
        ...
        <div className=" w-[80%] text-c1 dark:text-c2 text-center text-xs my-3">
          <span>© 2023 Infinity Digital Assets LLC. All rights reserved.</span>
        </div>
      </div>
    </div>
  );
